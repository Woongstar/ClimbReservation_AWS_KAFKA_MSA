<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            <Number label="CenterId" v-model="value.centerId" :editMode="editMode" :inputUI="''"/>
            <String label="ReservationDate" v-model="value.reservationDate" :editMode="editMode" :inputUI="''"/>
            ...
            <String label="ClientPhoneNum" v-model="value.clientPhoneNum" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
