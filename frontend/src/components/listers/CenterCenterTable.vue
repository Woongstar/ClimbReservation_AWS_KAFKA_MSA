        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <CenterCenter :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            headers: 
                [
                    { text: "centerId", value: "centerId" },
                    { text: "centerName", value: "centerName" },
                    { text: "centerLocation", value: "centerLocation" },
                    { text: "startTime", value: "startTime" },
                    { text: "endTime", value: "endTime" },
                    { text: "courses", value: "courses" },
                    { text: "enterFee", value: "enterFee" },
                ],
            center : [],
            newValue: {},
            tick : true,
        ...
        async created() {
            ...
            this.values = temp.data._embedded.centers;
